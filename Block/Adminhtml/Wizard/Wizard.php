...
namespace Adapttive\Wizard\Block\Adminhtml\Wizard;
...
/**
 * Wizard initialization block
 * Reference: \Magento\ConfigurableProduct\Block\Adminhtml\Product\Edit\Tab\Variations\Config\Matrix
 *
 * @api
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 * @since 100.0.2
 */
class Wizard extends \Magento\Backend\Block\Template
{
    /**
    ...
    {
        // TODO: temp data loading
        $product = $this->productRepository->get("449923");
        $registry = ObjectManager::getInstance()->get(\Magento\Framework\Registry::class);
        $registry->register('current_product', $product, true);
